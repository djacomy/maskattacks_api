...
def upgrade():
    ...
    op.add_column('product_batch', sa.Column('deliveryitem_id', sa.Integer(), nullable=False))
    op.add_column('product_batch', sa.Column('reference', sa.String(length=40), nullable=False))
    op.create_foreign_key(None, 'product_batch', 'product_deliveryitem', ['deliveryitem_id'], ['id'])
...
def downgrade():
    ...
    op.drop_column('product_batch', 'deliveryitem_id')
